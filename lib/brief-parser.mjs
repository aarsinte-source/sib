...
function estraiObiettivo(testo) {
  ...
  if (/\bfar[e]?\s+conoscere\b|\bconoscenza\b|\bawareness\b|\bvisibilit[aà]\b|\bnotoriet[aà]\b/i.test(daAnalizzare)) {
    return {
      objective: 'OUTCOME_AWARENESS',
      match: daAnalizzare.match(/\bfar[e]?\s+conoscere\b|\bconoscenza\b|\bawareness\b|\bvisibilit[aà]\b|\bnotoriet[aà]\b/i)[0],
      fonte,
    };
  }
