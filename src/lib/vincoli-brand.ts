...
export const CLAIM_VIETATI: { pattern: string; cosa: string }[] = [
  {
...
export const FIREWALL_PATTERN: { pattern: string; cosa: string }[] = [
  {
...
export const FORME_FLESSE: string[] = [
  "sklepie",
  "sklepu",
  "sklepy",
  "sklepem",
...
export const NUMERI_DOCUMENTATI: NumeroDocumentato[] = [
  {
 ...
 */
export function radice(termine: string): RegExp {
 ...
 */
export function negozioEccezione(frase: string): boolean {
 ...
 */
export function numeroDocumentato(testo: string, inizio: number, fine: number): boolean {
